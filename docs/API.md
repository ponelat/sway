...
| [options.customSchema] | <code>object</code> | The custom schema to be used for validation |
| [options.skipSemanticValidation] | <code>object</code> | If set to true semantic validation will be skipped |
